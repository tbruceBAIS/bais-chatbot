...
if (looksProductIntent(message)) {
  ...
  if (
    ...
    productResults = [
      { title: "Taps", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/6301" }
    ];
  }
  ...
  lowerMessage.includes("vises") ||
  lowerMessage.includes("vice") ||
  lowerMessage.includes("vices") ||
  lowerMessage.includes("magnet") ||
  lowerMessage.includes("magnets") ||
  lowerMessage.includes("demagnetizer") ||
  lowerMessage.includes("demagnetizers") ||
  lowerMessage.includes("positioning") ||
  lowerMessage.includes("lathe chuck") ||
  lowerMessage.includes("lathe chucks") ||
  lowerMessage.includes("center") ||
  lowerMessage.includes("centers") ||
  lowerMessage.includes("fixture") ||
  lowerMessage.includes("fixtures") ||
  lowerMessage.includes("fixturing") ||
  lowerMessage.includes("workholding")
) {
  ...
  if (
    ...
    productResults = [
      { title: "Magnets/Demagnetizers", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/70870" }
    ];
  }
    ...
    productResults = [
      { title: "Vises", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/70750" }
    ];
  }
    ...
    productResults = [
      { title: "Clamps", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/70780" }
    ];
  }
    ...
    productResults = [
      { title: "Positioning", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/8008" }
    ];
  }
    ...
    productResults = [
      { title: "Lathe Chucks, Centers", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/8009" }
    ];
  }
    ...
    productResults = [
      { title: "Stationary Fixturing", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/8011" }
    ];
  }

  else {
    productResults = [
      { title: "Clamping, Positioning, Workholding", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/70700" },
      { title: "Vises", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/70750" },
      { title: "Clamps", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/70780" },
      { title: "Positioning", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/8008" },
      { title: "Lathe Chucks, Centers", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/8009" },
  ...
  lowerMessage.includes("blanks") ||
  lowerMessage.includes("spare part") ||
  lowerMessage.includes("spare parts") ||
  lowerMessage.includes("cutting tool blank") ||
  lowerMessage.includes("cutting tool blanks") ||
  lowerMessage.includes("cutting tool spare") ||
  lowerMessage.includes("tool spare")
) {
  ...
  if (
    ...
    productResults = [
      { title: "Cutting Tool Blanks", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/6701" }
    ];
  }
    ...
    productResults = [
      { title: "Cutting Tool Spare Parts", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/6702" }
    ];
  }

  else {
    productResults = [
      { title: "Cutting Tools Spare Parts & Blanks", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/6700" },
      { title: "Cutting Tool Blanks", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/6701" },
      { title: "Cutting Tool Spare Parts", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/6702" }
    ];
  }
  ...
  lowerMessage.includes("heaters") ||
  lowerMessage.includes("thermostat") ||
  lowerMessage.includes("thermostats") ||
  lowerMessage.includes("hvac control") ||
  lowerMessage.includes("ice machine") ||
  lowerMessage.includes("ice machines") ||
  lowerMessage.includes("fan") ||
  lowerMessage.includes("fans") ||
  lowerMessage.includes("air circulator") ||
  lowerMessage.includes("air circulators") ||
  lowerMessage.includes("filter") ||
  lowerMessage.includes("filters") ||
  lowerMessage.includes("refrigerator") ||
  lowerMessage.includes("refrigerators") ||
  lowerMessage.includes("freezer") ||
  lowerMessage.includes("freezers") ||
  lowerMessage.includes("air conditioner") ||
  lowerMessage.includes("air conditioners") ||
  lowerMessage.includes("dehumidifier") ||
  lowerMessage.includes("dehumidifiers") ||
  lowerMessage.includes("air treatment") ||
  lowerMessage.includes("chiller") ||
  lowerMessage.includes("chillers") ||
  lowerMessage.includes("duct") ||
  lowerMessage.includes("ductwork") ||
  lowerMessage.includes("ventilation") ||
  lowerMessage.includes("exhaust") ||
  lowerMessage.includes("grille") ||
  lowerMessage.includes("grilles") ||
  lowerMessage.includes("register") ||
  lowerMessage.includes("registers") ||
  lowerMessage.includes("diffuser") ||
  lowerMessage.includes("diffusers") ||
  lowerMessage.includes("hvac cleaner") ||
  lowerMessage.includes("hvac cleaners")
) {
  ...
  if (
    ...
    productResults = [
      { title: "Heaters", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65135" }
    ];
  }
    ...
    lowerMessage.includes("thermostats") ||
    lowerMessage.includes("hvac control") ||
    lowerMessage.includes("hvac controls")
  ) {
    productResults = [
      { title: "HVAC Controls and Thermostats", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65140" }
    ];
  }
    ...
    productResults = [
      { title: "Ice Machines and Accessories", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65141" }
    ];
  }
    ...
    productResults = [
      { title: "Fans & Air Circulators", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65142" }
    ];
  }
    ...
    productResults = [
      { title: "HVAC Filters", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65139" }
    ];
  }
    ...
    productResults = [
      { title: "Refrigerators and Freezers", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65150" }
    ];
  }
    ...
    lowerMessage.includes("air conditioner") ||
    lowerMessage.includes("air conditioners") ||
    lowerMessage.includes("ac unit") ||
    lowerMessage.includes("a/c")
  ) {
    productResults = [
      { title: "Air Conditioners", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65152" }
    ];
  }
    ...
    lowerMessage.includes("dehumidifier") ||
    lowerMessage.includes("dehumidifiers") ||
    lowerMessage.includes("humidity control")
  ) {
    productResults = [
      { title: "Humidity Control Dehumidifiers", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65154" }
    ];
  }
    ...
    productResults = [
      { title: "Air Treatment", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65156" }
    ];
  }
    ...
    productResults = [
      { title: "Recirculating Chillers", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65158" }
    ];
  }
    ...
    lowerMessage.includes("duct") ||
    lowerMessage.includes("ductwork") ||
    lowerMessage.includes("duct fitting") ||
    lowerMessage.includes("duct fittings")
  ) {
    productResults = [
      { title: "Duct Work & Fittings", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65160" }
    ];
  }
    ...
    productResults = [
      { title: "Exhaust & Ventilation", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65162" }
    ];
  }

  else if (
    lowerMessage.includes("hvac maintenance") ||
    lowerMessage.includes("maintenance tool") ||
    lowerMessage.includes("maintenance tools")
  ) {
    productResults = [
      { title: "HVAC Maintenance Tools & Accessories", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65164" }
    ];
  }
    ...
    lowerMessage.includes("shutters")
  ) {
    productResults = [
      { title: "Shutters & Grilles", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65166" }
    ];
  }
    ...
    productResults = [
      { title: "Registers & Diffusers", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65168" }
    ];
  }
    ...
    lowerMessage.includes("hvac cleaner") ||
    lowerMessage.includes("hvac cleaners") ||
    lowerMessage.includes("coil cleaner")
  ) {
    productResults = [
      { title: "HVAC Cleaners", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65171" }
    ];
  }

  else if (
    lowerMessage.includes("testing equipment") ||
    lowerMessage.includes("hvac testing")
  ) {
    productResults = [
      { title: "Testing Equipment", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65173" }
    ];
  }

  else {
    productResults = [
      { title: "HVAC", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65108" },
      { title: "Heaters", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65135" },
      { title: "HVAC Filters", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65139" },
      { title: "Fans & Air Circulators", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65142" },
      { title: "Air Conditioners", url: "https://blue-prod-01.bessig.com/browse/catalogue/group/65152" },
